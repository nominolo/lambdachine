...
#define DEBUG_ALL             0xffffffffL

#ifdef NDEBUG
# define DEBUG_COMPONENTS 0
#else
# define DEBUG_COMPONENTS 0
// #define DEBUG_COMPONENTS    DEBUG_ALL
// #define DEBUG_COMPONENTS    DEBUG_MEMORY_MANAGER
...
// #define DEBUG_COMPONENTS    (DEBUG_TRACE_RECORDER|DEBUG_INTERPRETER|DEBUG_TRACE_ENTEREXIT|DEBUG_TRACE_PROGRESS|DEBUG_ASSEMBLER)
#endif
